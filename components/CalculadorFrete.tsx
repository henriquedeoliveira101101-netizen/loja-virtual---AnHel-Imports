...
export default function CalculadorFrete() {
  ...
  return (
    ...
    <div className="bg-neutral-900/50 p-6 rounded-xl border border-neutral-800 text-white">

      <div className="flex items-center gap-2 mb-4">

        <Truck size={18} className="text-hb-gold" />

        <h3 className="text-[10px] font-black uppercase tracking-widest text-neutral-200">Calcular Frete e Prazo</h3>
      ...
      <form onSubmit={calcularFrete} className="flex gap-2">
        ...
        <input
          ...
          className="flex-1 px-4 py-3 text-sm bg-transparent border border-neutral-700 text-white placeholder-neutral-500 rounded outline-none focus:border-hb-gold transition"
        ...
        <button
          ...
          className="bg-neutral-800 text-white px-6 py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-neutral-700 transition disabled:opacity-50 border border-neutral-700"
          ...
          {opcoesFrete.map((opcao, index) => (
            ...
            <div key={index} className="flex justify-between items-center py-3 border-b border-neutral-800 last:border-0">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-neutral-200 uppercase">{opcao.nome}</p>
